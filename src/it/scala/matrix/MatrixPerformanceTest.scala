...
//    l("My: %g", time_of_my)
  ...
  "MyMatrixOperations" should "do scalar operations fast 10x10" in { speed_ratio_for_dimentions(10, 10, new MatrixOperations() {}, MyMatrixOperations) should be < 1.2}
  it should "do scalar operations fast 200x200" in     { speed_ratio_for_dimentions(200, 200, new MatrixOperations() {}, MyMatrixOperations) should be < 0.9}
  it should "do scalar operations fast 1000x100" in    { speed_ratio_for_dimentions(1000, 100, new MatrixOperations() {}, MyMatrixOperations) should be < 0.7}
  it should "do scalar operations fast 100x1000" in    { speed_ratio_for_dimentions(100, 1000, new MatrixOperations() {}, MyMatrixOperations) should be < 0.7}
  it should "do scalar operations fast 1000x1" in      { speed_ratio_for_dimentions(1000, 1, new MatrixOperations() {}, MyMatrixOperations) should be < 1.3}
  it should "do scalar operations fast 10x1000" in     { speed_ratio_for_dimentions(10, 1000, new MatrixOperations() {}, MyMatrixOperations) should be < 1.1}

  "ActorBasedMatrixOperations" should "do scalar operations fast 10x1000" in     { speed_ratio_for_dimentions(10, 1000, MyMatrixOperations, ActorBasedMatrixOperations) should be < 0.5d}
